...
data class SignUpRequest(val firstName: String,val lastName: String,val email: String,val password: String, val confirmPassword: String)
data class SignUpResponse(val success: Boolean, val userId: String,  val message: String)
